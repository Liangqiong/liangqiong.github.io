...
- [NeurIPS 2026] **Unveiling Implicit Advantage Symmetry: Why GRPO Struggles with Exploration and Difficulty Adaptation**.
<br> <span style="color:blue;">  Zhiqi Yu, Zhangquan Chen, Mengting Liu, Heye Zhang, **Liangqiong Qu**<sup>#</sup>. ([Paper](https://arxiv.org/abs/2602.05548), [Code](https://github.com/HKU-HealthAI/A-GRAE))
- [ECCV 2026] **Discrete Diffusion Bridges for Spatiotemporally Aligned Image Translation and Generation**.
<br> <span style="color:blue;">  Xing Xie, Jiawei Liu, Shijun Zhou, Huijie Fan<sup>#</sup>, Zhi Han, Yandong Tang, **Liangqiong Qu**<sup>#</sup>. ([Paper](https://arxiv.org/pdf/2608.29997), [Code](https://github.com/HKU-HealthAI/DDB))
